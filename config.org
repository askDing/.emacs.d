...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "M-p ") 'lsp-workspace-folders-add)
  (global-set-key (kbd "M-p ") 'lsp-workspace-folders-remove)
...
#+begin_src emacs-lisp
  ...
  ;; |-----------------------------+-------------+--------------------------------------|
  (global-set-key (kbd "C-c .") 'c-set-style)   ;; code indentation style
  ...
  (global-set-key (kbd "C-?") 'lsp-format-buffer)        ;; format code     |
  ;; |-----------------------------+-------------+--------------------------------------|
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-ui
    ...
    (setq lsp-ui-sideline-show-hover t
          ...
          lsp-ui-sideline-update-mode 'pointo
          ;;lsp-ui-doc
          ;; lsp-ui-doc-enable t
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-java
    ...
    (setq lsp-java-jdt-download-url "https://download.eclipse.org/jdtls/snapshots/jdt-language-server-latest.tar.gz"
          ...
          lsp-java-server-install-dir "~/.emacs.d/.cache/lsp/eclipse.jdt.ls/"
          lsp-java-java-path "java"
          ;;lsp-java-workspace-dir "~/Code/Java/"
          lsp-java-pop-buffer-function 'lsp-java-show-buffer
          lsp-java-vmargs  '("-noverify" "-Xmx1G" "-XX:+UseG1GC" "-XX:+UseStringDeduplication") ;; default
...
#+begin_src emacs-lisp
  ...
  (use-package lsp-treemacs
    ...
    :commands lsp-treemacs-error-list-mode)

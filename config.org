...
#+begin_src emacs-lisp
  ...
  ;; |-----------------------------+-------------+--------------------------------------|
  (global-set-key (kbd "M-f") 'swiper);; | Search     
  (global-set-key (kbd "C-M-f") 'counsel-imenu);; | Search Tags       
  (global-set-key (kbd "M-%") 'query-replace);; | Replace  
  (global-set-key (kbd "C-M-%") 'query-replace-regexp) ;; | Replace Regex      
  ;; |-----------------------------+-------------+--------------------------------------|
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-s") 'avy-goto-char);; | Goto Char  
